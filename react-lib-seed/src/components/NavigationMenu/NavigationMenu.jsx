...
function template() {
  return (
    <nav className="navigation-menu navbar navbar-expand-lg" styleName="ams-navbar" >
      <div styleName="overlay" className={this.state.hidden === true ? "" : "show"} onClick={this.toggleMenu}></div>
      ...
      <div className="nav-item dropdown" styleName="menuBox">
        <a className="nav-link" styleName="dropdown-toggle" href="javascript:;" data-toggle="dropdown">
          {this.props.userName} <i className="fa fa-user-circle"></i>
        </a>
        <div className="dropdown-menu dropdown-menu-right" styleName="userDropdown" aria-labelledby="user-dropdown">
