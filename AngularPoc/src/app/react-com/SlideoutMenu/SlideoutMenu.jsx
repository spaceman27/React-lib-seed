...
function template() {
    ...
    return (
        <div className="container">
            <div className="slideoutIcon" onClick={this.props.showMenu}>
                <div className="fas fa-th"></div>
            </div>

            <div id="slideoutMenu" className={this.props.hidden === true ? "hiddenMenu" : "shownMenu ams-window"}>
                <div className="row">
                    <div className="col pull-right slideoutIcon closeIcon" onClick={this.props.showMenu}>
